...
public class SelectExportListAdapter extends RecyclerView.Adapter<SelectExportListAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public void setmOnItemClickListener(SelectExportListAdapter.OnItemClickListener mOnItemClickListener) {
        this.mOnItemClickListener = mOnItemClickListener;
    }

    private SelectExportListAdapter.OnItemClickListener mOnItemClickListener = null;

    public static interface OnItemClickListener {
        void onItemClick(View view,int position);
    }

    public SelectExportListAdapter(ArrayList<String> data){
        this.mData = data;
    }

    @Override
    public SelectExportListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        // 实例化viewholder
        SelectExportListAdapter.ViewHolder viewHolder = new SelectExportListAdapter.ViewHolder(v);
        v.setOnClickListener(this);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(SelectExportListAdapter.ViewHolder holder, int position) {
        // 绑定数据
