...
public class CameraActivity extends AppCompatActivity implements HomeSearchView, TextWatcher, KnowledgeItemAdapter.OnItemClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.addItemDecoration(new MyDividerItemDecoration(CameraActivity.this, LinearLayoutManager.VERTICAL));
    ...
    private void initView() {
        ...
        itemThree = (TextView) findViewById(R.id.item_three);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.item_two:
                itemSelect(itemTwo);
                mSearchEdt.setText("板间梁");
                break;
            case R.id.item_three:
                itemSelect(itemThree);
                mSearchEdt.setText("梁内管线");
                break;
        }
    }
...
//        Toast.makeText(CameraActivity.this, "网络出错", Toast.LENGTH_SHORT).show();
    ...
    private void itemSelect(TextView textView){
        ...
        itemThree.setTextColor(getResources().getColor(R.color.color_999999));
        itemThree.setBackground(getResources().getDrawable(R.drawable.select_tags));
