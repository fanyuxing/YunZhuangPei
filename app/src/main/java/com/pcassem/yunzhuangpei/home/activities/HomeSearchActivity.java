...
public class HomeSearchActivity extends AppCompatActivity implements HomeSearchView, TextWatcher, KnowledgeItemAdapter.OnItemClickListener, View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.addItemDecoration(new MyDividerItemDecoration(HomeSearchActivity.this, LinearLayoutManager.VERTICAL));
    ...
    @Override
    public void onError() {
//        Toast.makeText(HomeSearchActivity.this, "网络出错", Toast.LENGTH_SHORT).show();
    }
