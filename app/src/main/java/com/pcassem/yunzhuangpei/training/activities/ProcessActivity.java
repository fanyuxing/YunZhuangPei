...
public class ProcessActivity extends ActionBarActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    String firstProcessList[] = new String[]{"施工前准备阶段", "施工阶段", "验收阶段"};
    String secondProcessList[][] = new String[][]{
            new String[]{"设计视图", "施工策划", "施工工具"},
            new String[]{"基础阶段", "主题阶段", "装修阶段"},
            new String[]{"验收流程", "验收资料"}};
    String thirdProcessList[][][] = new String[][][]{
            new String[][]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationUtil.setHeight(98);

        selectSecondListAdapter = new SelectSecondListAdapter(ProcessActivity.this, firstProcessList);
    ...
    public void setSubList(int position) {
        ...
        selectThirdListAdapter = new SelectThirdListAdapter(ProcessActivity.this, secondProcessList, position);
        selectThirdList.setAdapter(selectThirdListAdapter);

        //初始化第三层列表展示
        selectThirdListAdapter.setSelectedPosition(0);
        popularTagsData(thirdProcessList[0][0]);
        ...
        selectThirdList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int pos, long arg3) {
                ...
                popularTagsData(thirdProcessList[location][pos]);
            }
        });
    }
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            mFlowLayout.setOnItemClickClick(new FlowLayout.OnItemClickListener() {
                ...
                public void OnItemClick(int position) {
                    Toast.makeText(ProcessActivity.this, mFlowLayout.getChildAt(position).getMeasuredWidth() + "", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
